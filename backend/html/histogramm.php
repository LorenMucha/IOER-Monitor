...
$TYP_FUELLUNG = getIndTypFuellung($indikator);
$farbwerte_min = getIndColor_MIN($indikator);
$farbwerte_max = getIndColor_MAX($indikator);
...
switch ($TYP_FUELLUNG) {
			case 'Farbbereich':
				...
				echo  '<rect x="'.$xl=($XD).'" width="'.$HBBreite = ($Hist_Box_Schrittweite*51).' height="'.$HBH = ($Hist_Box_Hoehe + 4).'px style="fill: url(#IndikatorenFarbbereich_horizontal) stroke="none" />';
